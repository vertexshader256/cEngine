...
bool dumpstack; // added this (washburn)
bool dumpsource; // added this (washburn)
bool warning_is_error; // added this (washburn)
bool enable_warning; // added this (washburn)
